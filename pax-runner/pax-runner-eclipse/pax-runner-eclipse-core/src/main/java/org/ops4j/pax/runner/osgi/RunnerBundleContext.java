    ...
    extends UnsupportedBundleContext
{
	...
	public void removeServiceListener(ServiceListener serviceListener) {
        m_context.getEventDispatcher().removeListener(m_bundle, ServiceListener.class, serviceListener);
	}
	...
	public boolean ungetService(ServiceReference serviceReference) {
        return m_context.getServiceRegistry().ungetService( m_bundle, serviceReference );
	}
